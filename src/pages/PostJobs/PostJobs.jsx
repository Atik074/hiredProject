...
const PostJobs = () => {
    ...
    const handleSubmit = (e) => {
      ...
      if(isEdit){
        const editJobs = jobs.map(job =>job.id === jobEdit.id ? {...job, ...newJob}:job)
    ...
    return (
      <div className="max-w-screen-lg mx-auto p-4">
       ...
       {
        showForm !== true &&  <table className="min-w-full bg-white border border-gray-300 rounded-lg mt-4">
          ...
          {jobs.map((job) => (
            <tr key={job.id} className="border-b border-gray-200">
              ...
              <td>
                 ...
                 className="mr-6 border-none bg-red-500"> <FaPen/></Button>
                 <Button
                   onClick={()=>handleDeleteJob(job.id)}
                  className="mr-6 border-none bg-red-500"><MdDelete
